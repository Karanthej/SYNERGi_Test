...
import StepSynergiIdeas from "@/components/onboarding/StepSynergiIdeas";
import StepUsername from "@/components/onboarding/StepUsername";
import FounderReviewSubmit from "@/components/onboarding/FounderReviewSubmit";
      ...
      <div className="flex-1 flex flex-col min-h-[100dvh] overflow-x-hidden">
        ...
        <main className="flex-1 max-w-3xl w-full mx-auto p-4 md:p-8 lg:p-12">
          <AnimatePresence mode="wait">
            ...
            {currentStep === 3 && <StepSynergiIdeas key="step4" onNext={handleNext} onBack={handleBack} />}
            {currentStep === 4 && <StepUsername key="step5" onNext={handleNext} onBack={handleBack} />}
            {currentStep === 5 && <FounderReviewSubmit key="step6" onBack={handleBack} />}
          </AnimatePresence>
        </main>
      </div>
    </div>
