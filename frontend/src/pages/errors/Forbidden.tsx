...
export default function Forbidden() {
  ...
  return (
    <div className="min-h-[100dvh] bg-transparent flex flex-col items-center justify-center p-4 text-center">
      ...
      <h1 className="text-6xl font-bold tracking-tight mb-4 text-white">403</h1>
      <h2 className="text-2xl font-semibold mb-2">Access Forbidden</h2>
      <p className="text-white/80 max-w-md mb-8">You do not have permission to access this resource. Please contact your administrator.</p>
