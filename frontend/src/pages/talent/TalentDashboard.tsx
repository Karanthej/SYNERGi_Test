...
export default function TalentDashboard() {
  ...
  return (
    <div className="p-0 sm:p-4 lg:p-8 w-full max-w-[1920px] mx-auto space-y-6 sm:space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">Talent Dashboard</h2>
          <p className="text-white/80 mt-2">Overview of your applications and workspace activity.</p>
        </div>
        <Link to="/talent/startups" className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
          Browse
        </Link>
      </div>
        ...
        <div className="flex flex-col gap-6 sm:gap-8 min-w-0">
          <div className="grid gap-4 sm:gap-6 grid-cols-2 lg:grid-cols-[repeat(auto-fit,minmax(240px,1fr))]">
            <div className="glass-surface p-4 sm:p-6 rounded-2xl shadow-sm border border-[var(--glass-border)]">
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white">{data.applicationsSubmitted}</div>
            ...
            <div className="glass-surface p-4 sm:p-6 rounded-2xl shadow-sm border border-[var(--glass-border)]">
              <div className="flex flex-row items-center justify-between pb-2">
                <h3 className="text-xs sm:text-sm font-medium text-foreground dark:text-white">Workspaces</h3>
                <svg className="h-4 w-4 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white">{data.acceptedStartups}</div>
            ...
            <div className="glass-surface p-4 sm:p-6 rounded-2xl shadow-sm border border-[var(--glass-border)]">
              <div className="flex flex-row items-center justify-between pb-2">
                <h3 className="text-xs sm:text-sm font-medium text-foreground dark:text-white">My Tasks</h3>
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white">{data.assignedTasks}</div>
            ...
            <div className="glass-surface p-4 sm:p-6 rounded-2xl shadow-sm border border-[var(--glass-border)]">
              <div className="flex flex-row items-center justify-between pb-2">
                <h3 className="text-xs sm:text-sm font-medium text-foreground dark:text-white">Meetings</h3>
                <svg className="h-4 w-4 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white">{data.upcomingMeetings}</div>
